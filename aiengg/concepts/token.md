...
> A unit of text consumed by the model. Generated by an algorithm like **Byte Pair Encoding (BPE)**. Often sub-word — "coronation" may split into "coro" + "nation". Surprising at the surface, but optimised for LLM consumption.
