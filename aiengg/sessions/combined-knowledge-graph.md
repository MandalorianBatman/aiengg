# Combined Knowledge Graph — Recordings 51 & 52

Two classes from the AI Engineering Cohort (InterviewReady / Gaurav Sen) covering the foundations of how LLMs work end-to-end.
...
- [Vaswani et al., 2017 — Attention Is All You Need](https://arxiv.org/abs/1706.03762) (R51)
...
- **DeepSeek** — GRPO populariser
- **Google** — private datasets
- **OpenAI** — tool-calling example (note: the lecture does NOT specify GPT-2)
